...
const ProjectThumbnail = (props) => {
    return (
        <Link href={props.projLink} className='w-full flex flex-col items-center justify-center hover:opacity-60'>
            ...
            <p className='flex leading-[60px] text-center items-center justify-center font-bebas text-3xl lg:text-[45px] w-full min-h-[100px] lg:rounded-t-3xl text-white bg-blue-400'>{props.projName}</p>
